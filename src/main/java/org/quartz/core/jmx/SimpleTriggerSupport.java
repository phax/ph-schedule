...
public class SimpleTriggerSupport
{
  ...
  private static final String [] ITEM_DESCRIPTIONS = new String [] { "repeatCount",
                                                                     "repeatInterval",
                                                                     "timesTriggered" };
  ...
  public static CompositeData toCompositeData (final SimpleTrigger trigger)
  {
    try
    {
      return new CompositeDataSupport (COMPOSITE_TYPE,
                                       ITEM_NAMES,
                                       new Object [] { trigger.getRepeatCount (),
  ...
  public static TabularData toTabularData (final List <? extends SimpleTrigger> triggers)
  {
    final TabularData tData = new TabularDataSupport (TABULAR_TYPE);
    if (triggers != null)
    {
      final ArrayList <CompositeData> list = new ArrayList <> ();
      for (final SimpleTrigger trigger : triggers)
      {
  ...
  {
    final SimpleTriggerImpl result = new SimpleTriggerImpl ();
