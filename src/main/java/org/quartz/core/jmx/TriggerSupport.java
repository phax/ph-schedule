...
public class TriggerSupport
{
  ...
  public static CompositeData toCompositeData (final Trigger trigger)
  {
    try
    {
      return new CompositeDataSupport (COMPOSITE_TYPE,
                                       ITEM_NAMES,
                                       new Object [] { trigger.getKey ().getName (),
  ...
  public static TabularData toTabularData (final List <? extends Trigger> triggers)
  {
  ...
  public static List <CompositeData> toCompositeList (final List <? extends Trigger> triggers)
  {
    final List <CompositeData> result = new ArrayList <> ();
    for (final Trigger trigger : triggers)
    {
      final CompositeData cData = TriggerSupport.toCompositeData (trigger);
      if (cData != null)
      {
        result.add (cData);
      }
  ...
  public static void initializeTrigger (final MutableTrigger trigger, final CompositeData cData)
  {
  ...
  public static void initializeTrigger (final MutableTrigger trigger, final Map <String, Object> attrMap)
  {
    ...
    if (attrMap.containsKey ("jobDataMap"))
    {
      ...
      final Map <String, Object> mapTyped = (Map <String, Object>) attrMap.get ("jobDataMap");
