...
public interface TriggerListener
{
   ...
   * <code>{@link org.quartz.JobDetail}</code> is about to be executed.
   * </p>
   * <p>
   ...
   * Called by the <code>{@link Scheduler}</code> when a
   * <code>{@link Trigger}</code> has fired, and it's associated
   * <code>{@link org.quartz.JobDetail}</code> is about to be executed. If the
   ...
   * <code>{@link org.quartz.JobDetail}</code> has been executed, and it's
