...
public class SimpleTriggerImpl extends AbstractTrigger <SimpleTrigger> implements SimpleTrigger, CoreTrigger
{
   ...
   */
  @Deprecated
  public SimpleTriggerImpl (final String name, final String group)
  {
  ...
  /**
   * <p>
   * Create a <code>SimpleTrigger</code> that will occur immediately, and repeat
   * at the the given interval the given number of times.
   * </p>
   *
   * @deprecated use a TriggerBuilder instead
   */
  @Deprecated
  public SimpleTriggerImpl (final String name, final int repeatCount, final long repeatInterval)
  {
   ...
   */
  @Deprecated
  public SimpleTriggerImpl (final String name, final String group, final int repeatCount, final long repeatInterval)
  {
  ...
  /**
   * <p>
   * Create a <code>SimpleTrigger</code> that will occur at the given time, and
   * not repeat.
   * </p>
   *
   * @deprecated use a TriggerBuilder instead
   */
  @Deprecated
  public SimpleTriggerImpl (final String name, final Date startTime)
  {
   ...
   * <p>
   * Create a <code>SimpleTrigger</code> that will occur at the given time, and
   * repeat at the the given interval the given number of times, or until the
   * given end time.
   * </p>
   *
   * @param startTime
   ...
   *        quit repeat firing.
   * @param repeatCount
   *        The number of times for the <code>Trigger</code> to repeat firing,
   *        use {@link #REPEAT_INDEFINITELY} for unlimited times.
  ...
  /**
   * <p>
   * Create a <code>SimpleTrigger</code> that will occur at the given time, fire
   * the identified <code>Job</code> and repeat at the the given interval the
   * given number of times, or until the given end time.
   * </p>
   *
   * @param startTime
   *        A <code>Date</code> set to the time for the <code>Trigger</code> to
   ...
   * @param repeatCount
   *        The number of times for the <code>Trigger</code> to repeat firing,
   *        use {@link #REPEAT_INDEFINITELY}for unlimitted times.
   * @param repeatInterval
   *        The number of milliseconds to pause between the repeat firing.
   * @deprecated use a TriggerBuilder instead
   */
