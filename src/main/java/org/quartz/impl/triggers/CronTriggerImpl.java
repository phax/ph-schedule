...
public class CronTriggerImpl extends AbstractTrigger <CronTrigger> implements CronTrigger, CoreTrigger
{
   ...
   */
  @Deprecated
  public CronTriggerImpl (final String name)
  {
    this (name, null);
  }
   ...
   */
  @Deprecated
  public CronTriggerImpl (final String name, final String group)
  {
    super (name, group);
    setStartTime (new Date ());
    setTimeZone (TimeZone.getDefault ());
   ...
   */
  @Deprecated
  public CronTriggerImpl (final String name, final String group, final String cronExpression) throws ParseException
  {
   ...
   */
  @Deprecated
  public CronTriggerImpl (final String name, final String group, final String jobName, final String jobGroup)
  {
  ...
  /**
   * <p>
   * Create a <code>CronTrigger</code> with the given name and group, associated
   * with the identified <code>{@link org.quartz.JobDetail}</code>, and with the
   ...
   * Create a <code>CronTrigger</code> with the given name and group, associated
   * with the identified <code>{@link org.quartz.JobDetail}</code>, and with the
   * given "cron" expression resolved with respect to the <code>TimeZone</code>.
   * </p>
   *
   * @deprecated use a TriggerBuilder instead
   */
  ...
  /**
   * <p>
   * Create a <code>CronTrigger</code> that will occur at the given time, until
   * the given end time.
   * </p>
   * <p>
   * If null, the start-time will also be set to the current time, the time zone
   * will be set the the system's default.
   * </p>
   *
   * @param startTime
   ...
   * <code>timeZone</code> occurring from the <code>startTime</code> until the
   * given <code>endTime</code>.
   * </p>
   * <p>
   * If null, the start-time will also be set to the current time. If null, the
   * time zone will be set to the system's default.
   * </p>
   *
   * @param name
   ...
   *        of the <code>Trigger</code>
   * @param jobName
   *        name of the <code>{@link org.quartz.JobDetail}</code> executed on
   *        firetime
   * @param jobGroup
   *        group of the <code>{@link org.quartz.JobDetail}</code> executed on
   *        firetime
   * @param startTime
   *        A <code>Date</code> set to the earliest time for the
   *        <code>Trigger</code> to start firing.
   * @param endTime
   *        A <code>Date</code> set to the time for the <code>Trigger</code> to
   *        quit repeat firing.
   * @param cronExpression
   *        A cron expression dictating the firing sequence of the
   *        <code>Trigger</code>
   * @param timeZone
   *        Specifies for which time zone the <code>cronExpression</code> should
   *        be interpreted, i.e. the expression 0 0 10 * * ?, is resolved to
   *        10:00 am in this time zone.
   ...
   */
  @Override
  public void updateAfterMisfire (final org.quartz.Calendar cal)
  {
   ...
   */
  @Override
  public void triggered (final org.quartz.Calendar calendar)
  {
   ...
   */
  @Override
  public void updateWithNewCalendar (final org.quartz.Calendar calendar, final long misfireThreshold)
  {
   ...
   */
  @Override
  public Date computeFirstFireTime (final org.quartz.Calendar calendar)
  {
