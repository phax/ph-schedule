...
/**
 * An interface which provides an implementation for storing a particular type
 * of <code>Trigger</code>'s extended properties.
 *
 * @author jhouse
 */
public interface TriggerPersistenceDelegate
{
  ...
  public TriggerPropertyBundle loadExtendedTriggerProperties (Connection conn,
  ...
  class TriggerPropertyBundle
  {
    ...
    public TriggerPropertyBundle (final ScheduleBuilder <?> sb,
                                  final String [] statePropertyNames,
                                  final Object [] statePropertyValues)
    {
      this.sb = sb;
