 ...
 * getting/setting the trigger's fields, and creating the
 * {@link ScheduleBuilder} for the particular type of trigger.
 *
 * @see CalendarIntervalTriggerPersistenceDelegate for an example extension
 * @author jhouse
 */
public abstract class SimplePropertiesTriggerPersistenceDelegateSupport implements
                                                                        ...
                                                                        StdJDBCConstants
{
  ...
  protected static final String SELECT_SIMPLE_PROPS_TRIGGER = "SELECT *" +
                                                              " FROM " +
                                                              TABLE_PREFIX_SUBST +
                                              ...
                                              final JobDetail jobDetail) throws SQLException, IOException
  {
    ...
    final SimplePropertiesTriggerProperties properties = getTriggerProperties (trigger);
                                                              ...
                                                              final TriggerKey triggerKey) throws SQLException
  {
    ...
    try
    {
      ...
      if (rs.next ())
      {
        final SimplePropertiesTriggerProperties properties = new SimplePropertiesTriggerProperties ();
