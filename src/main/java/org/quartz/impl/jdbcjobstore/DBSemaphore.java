...
/**
 * Base class for database based lock handlers for providing thread/resource
 * locking in order to protect resources from being altered by multiple threads
 * at the same time.
 */
public abstract class DBSemaphore implements Semaphore, Constants, StdJDBCConstants, TablePrefixAware
{
  ...
  public DBSemaphore (final String tablePrefix,
                      final String schedName,
                      final String defaultSQL,
                      final String defaultInsertSQL)
  {
  ...
  protected abstract void executeSQL (Connection conn,
                                      ...
                                      String theExpandedInsertSQL) throws LockException;
   ...
   */
  public boolean obtainLock (final Connection conn, final String lockName) throws LockException
  {
   ...
   * resource.
   */
  public boolean isLockOwner (final String lockName)
  {
  ...
  protected void setInsertSQL (final String insertSql)
  {
