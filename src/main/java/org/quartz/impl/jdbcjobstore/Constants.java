 ...
 * org.quartz.impl.jdbcjobstore.DriverDelegate}</code> class that needs to use
 * the constants contained herein.
 * </p>
 *
...
public interface Constants
{
  ...
  /**
   * @deprecated Whether a trigger has misfired is no longer a state, but rather
   *             now identified dynamically by whether the trigger's next fire
