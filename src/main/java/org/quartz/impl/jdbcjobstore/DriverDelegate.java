 ...
 * org.quartz.spi.JobStore}</code> interface except each method has an
 * additional <code>{@link java.sql.Connection}</code> parameter.
 * </p>
 * <p>
...
public interface DriverDelegate
{
  ...
  public void initialize (Logger logger,
                          ...
                          String initString) throws NoSuchDelegateException;
  ...
  /**
   * <p>
   * Get the names of all of the triggers that have misfired - according to the
   * given timestamp.
   * </p>
   *
   * @param conn
  ...
  /**
   * <p>
   * Get the names of all of the triggers in the given states that have misfired
  ...
  /**
   * <p>
   * Get the number of triggers in the given state that have misfired -
   * according to the given timestamp.
   * </p>
   *
   * @param conn
   ...
   */
  List <OperableTrigger> selectTriggersForRecoveringJobs (Connection conn) throws SQLException,
                                                                           IOException,
   ...
   * @param conn
   *        the DB Connection
   * @return true if the job exists and disallows concurrent execution, false
   *         otherwise
   */
   ...
   */
  JobDetail selectJobDetail (Connection conn, JobKey jobKey, ClassLoadHelper loadHelper) throws ClassNotFoundException,
                                                                                         IOException,
                                                                                         SQLException;
   ...
   */
  int insertTrigger (Connection conn, OperableTrigger trigger, String state, JobDetail jobDetail) throws SQLException,
                                                                                                  IOException;
   ...
   * @return the number of rows updated
   */
  int updateTrigger (Connection conn, OperableTrigger trigger, String state, JobDetail jobDetail) throws SQLException,
                                                                                                  IOException;
  ...
  /**
   * <p>
   * Update the states of any triggers associated with the given job, that are
   ...
   */
  List <OperableTrigger> selectTriggersForJob (Connection conn, JobKey jobKey) throws SQLException,
                                                                               ClassNotFoundException,
                                                                               IOException,
   ...
   * @throws JobPersistenceException
   */
  List <OperableTrigger> selectTriggersForCalendar (Connection conn, String calName) throws SQLException,
                                                                                     ClassNotFoundException,
                                                                                     IOException,
                                                                                     JobPersistenceException;
   ...
   */
  JobDataMap selectTriggerJobDataMap (Connection conn, String triggerName, String groupName) throws SQLException,
                                                                                             ClassNotFoundException,
                                                                                             IOException;
   ...
   */
  Calendar selectCalendar (Connection conn, String calendarName) throws ClassNotFoundException,
                                                                 IOException,
                                                                 SQLException;
  ...
  /**
   * <p>
   * Update a fired trigger record. Will update the fields "firing instance",
   * "fire time", and "state".
   * </p>
   *
   * @param conn
   ...
   * </p>
   * <p>
   * If instanceId is not null, then only the record for the identified instance
   * will be returned.
   * </p>
   *
   * @param conn
