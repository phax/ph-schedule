 ...
 * org.quartz.impl.jdbcjobstore.Constants}</code> to include the query string
 * constants in use by the <code>{@link
 * org.quartz.impl.jdbcjobstore.StdJDBCDelegate}</code> class.
 * </p>
 *
...
public interface StdJDBCConstants extends Constants
{
  ...
  String SELECT_JOB_EXISTENCE = "SELECT " +
                                COL_JOB_NAME +
                                " FROM " +
                                TABLE_PREFIX_SUBST +
                                TABLE_JOB_DETAILS +
  ...
  String SELECT_JOB_DETAIL = "SELECT *" +
                             " FROM " +
                             TABLE_PREFIX_SUBST +
                             TABLE_JOB_DETAILS +
                             " WHERE " +
  ...
  String SELECT_NUM_JOBS = "SELECT COUNT(" +
                           COL_JOB_NAME +
                           ") " +
                           " FROM " +
                           TABLE_PREFIX_SUBST +
  ...
  String SELECT_JOBS_IN_GROUP_LIKE = "SELECT " +
                                     COL_JOB_NAME +
                                     ", " +
                                     COL_JOB_GROUP +
                                     " FROM " +
  ...
  String SELECT_JOBS_IN_GROUP = "SELECT " +
                                COL_JOB_NAME +
                                ", " +
                                COL_JOB_GROUP +
                                " FROM " +
  ...
  String UPDATE_TRIGGER_SKIP_DATA = "UPDATE " +
                                    TABLE_PREFIX_SUBST +
                                    TABLE_TRIGGERS +
                                    " SET " +
                                    COL_JOB_NAME +
  ...
  String SELECT_SIMPLE_TRIGGER = "SELECT *" +
                                 " FROM " +
                                 TABLE_PREFIX_SUBST +
                                 TABLE_SIMPLE_TRIGGERS +
                                 " WHERE " +
  ...
  String SELECT_CRON_TRIGGER = "SELECT *" +
                               " FROM " +
                               TABLE_PREFIX_SUBST +
                               TABLE_CRON_TRIGGERS +
                               " WHERE " +
  ...
  String SELECT_BLOB_TRIGGER = "SELECT *" +
                               " FROM " +
                               TABLE_PREFIX_SUBST +
                               TABLE_BLOB_TRIGGERS +
                               " WHERE " +
  ...
  String SELECT_CALENDARS = "SELECT " +
                            COL_CALENDAR_NAME +
                            " FROM " +
                            TABLE_PREFIX_SUBST +
                            TABLE_CALENDARS +
  ...
  String DELETE_ALL_SIMPLE_TRIGGERS = "DELETE FROM " +
                                      TABLE_PREFIX_SUBST +
                                      "SIMPLE_TRIGGERS " +
                                      " WHERE " +
                                      COL_SCHEDULER_NAME +
                                      " = " +
                                      SCHED_NAME_SUBST;
  String DELETE_ALL_SIMPROP_TRIGGERS = "DELETE FROM " +
                                       TABLE_PREFIX_SUBST +
                                       "SIMPROP_TRIGGERS " +
                                       " WHERE " +
                                       COL_SCHEDULER_NAME +
                                       " = " +
                                       SCHED_NAME_SUBST;
  String DELETE_ALL_CRON_TRIGGERS = "DELETE FROM " +
                                    TABLE_PREFIX_SUBST +
                                    "CRON_TRIGGERS" +
                                    " WHERE " +
                                    COL_SCHEDULER_NAME +
                                    " = " +
                                    SCHED_NAME_SUBST;
  String DELETE_ALL_BLOB_TRIGGERS = "DELETE FROM " +
                                    TABLE_PREFIX_SUBST +
                                    "BLOB_TRIGGERS" +
                                    " WHERE " +
                                    COL_SCHEDULER_NAME +
                                    " = " +
                                    SCHED_NAME_SUBST;
  String DELETE_ALL_TRIGGERS = "DELETE FROM " +
                               TABLE_PREFIX_SUBST +
                               "TRIGGERS" +
                               " WHERE " +
                               COL_SCHEDULER_NAME +
                               " = " +
                               SCHED_NAME_SUBST;
  String DELETE_ALL_JOB_DETAILS = "DELETE FROM " +
                                  TABLE_PREFIX_SUBST +
                                  "JOB_DETAILS" +
                                  " WHERE " +
                                  COL_SCHEDULER_NAME +
                                  " = " +
                                  SCHED_NAME_SUBST;
  String DELETE_ALL_CALENDARS = "DELETE FROM " +
                                TABLE_PREFIX_SUBST +
                                "CALENDARS" +
                                " WHERE " +
                                COL_SCHEDULER_NAME +
                                " = " +
                                SCHED_NAME_SUBST;
  String DELETE_ALL_PAUSED_TRIGGER_GRPS = "DELETE FROM " +
                                          TABLE_PREFIX_SUBST +
                                          "PAUSED_TRIGGER_GRPS" +
                                          " WHERE " +
                                          COL_SCHEDULER_NAME +
  ...
  String SELECT_FIRED_TRIGGER_INSTANCE_NAMES = "SELECT DISTINCT " +
                                               COL_INSTANCE_NAME +
                                               " FROM " +
                                               TABLE_PREFIX_SUBST +
                                               TABLE_FIRED_TRIGGERS +
