 ...
 * <code>{@link org.quartz.core.JobRunShell}</code> to be used within the
 * <class>{@link org.quartz.core.QuartzScheduler} </code> instance.
 * </p>
 *
 * @author James House
 */
public class StdJobRunShellFactory implements JobRunShellFactory
{
  ...
  /**
   * <p>
   * Called by the <class>{@link org.quartz.core.QuartzSchedulerThread} </code>
