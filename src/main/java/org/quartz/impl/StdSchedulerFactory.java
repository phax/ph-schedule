 ...
 * <code>{@link org.quartz.spi.ThreadPool}</code>, and other SPI classes will be
 * created by name, and then any additional properties specified for them in the
 * config file will be set on the instance by calling an equivalent 'set'
 * method. For example if the properties file contains the property
...
public class StdSchedulerFactory implements SchedulerFactory
{
   ...
   * contents of a <code>Properties</code> file and overriding System
   * properties.
   * </p>
   * <p>
   * By default a properties file named "quartz.properties" is loaded from the
   ...
   * <p>
   * Initialize the <code>{@link org.quartz.SchedulerFactory}</code> with the
   * contents of the <code>Properties</code> file with the given name.
   * </p>
   */
   ...
   * <p>
   * Initialize the <code>{@link org.quartz.SchedulerFactory}</code> with the
   * contents of the <code>Properties</code> file opened with the given
