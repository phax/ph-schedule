...
public class JNDIConnectionProvider implements ConnectionProvider
{
   ...
   */
  public JNDIConnectionProvider (final String jndiUrl, final boolean alwaysLookup)
  {
    this.url = jndiUrl;
   ...
   *        The URL for the DataSource
   * @param jndiProps
   *        The JNDI properties to use when establishing the InitialContext for
   *        the lookup of the given URL.
   */
  public JNDIConnectionProvider (final String jndiUrl, final Properties jndiProps, final boolean alwaysLookup)
  {
    this.url = jndiUrl;
  ...
  public Connection getConnection () throws SQLException
  {
    ...
    catch (final Exception e)
    {
      ...
      throw new SQLException ("Could not retrieve datasource via JNDI url '" +
                              url +
                              "' " +
                              e.getClass ().getName () +
                              ": " +
  ...
  public void setAlwaysLookup (final boolean b)
  {
    alwaysLookup = b;
  }
