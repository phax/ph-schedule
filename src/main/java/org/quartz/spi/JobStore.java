 ...
 * <code>{@link org.quartz.Job}</code> and
 * <code>{@link org.quartz.Trigger}</code> storage mechanism for the
...
public interface JobStore
{
  ...
  /**
   * Remove (delete) the <code>{@link org.quartz.Job}</code> with the given key,
   * and any <code>{@link org.quartz.Trigger}</code> s that reference it.
   * <p>
  ...
  /**
   * Get the keys of all of the <code>{@link org.quartz.Job}</code> s that have
   ...
   * and that the <code>{@link org.quartz.JobDataMap}</code> in the given
