 ...
 * <code>{@link ITrigger}</code> fires. In general, applications that use a <code>Scheduler</code>
...
public interface ITriggerListener
{
  ...
  /**
   * <p>
   * Called by the <code>{@link IScheduler}</code> when a <code>{@link ITrigger}</code> has fired,
   * and it's associated <code>{@link com.helger.quartz.IJobDetail}</code> is about to be executed.
   * </p>
   * <p>
   ...
   * Called by the <code>{@link IScheduler}</code> when a <code>{@link ITrigger}</code> has fired,
   * and it's associated <code>{@link com.helger.quartz.IJobDetail}</code> is about to be executed.
   * If the implementation vetos the execution (via returning <code>true</code>), the job's execute
  ...
  /**
   * <p>
   * Called by the <code>{@link IScheduler}</code> when a <code>{@link ITrigger}</code> has
   * misfired.
   * </p>
   * <p>
   ...
   * <p>
   * Called by the <code>{@link IScheduler}</code> when a <code>{@link ITrigger}</code> has fired,
   * it's associated <code>{@link com.helger.quartz.IJobDetail}</code> has been executed, and it's
