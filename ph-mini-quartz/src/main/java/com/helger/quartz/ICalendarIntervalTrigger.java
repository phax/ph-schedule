 ...
 * <p>
 * The trigger will fire every N (see {@link #getRepeatInterval()} ) units of calendar time (see
 * {@link #getRepeatIntervalUnit()}) as specified in the trigger's definition. This trigger can
 * achieve schedules that are not possible with {@link ISimpleTrigger} (e.g because months are not a
 * fixed number of seconds) or {@link ICronTrigger} (e.g. because "every 5 months" is not an even
 * divisor of 12).
 * </p>
 * <p>
