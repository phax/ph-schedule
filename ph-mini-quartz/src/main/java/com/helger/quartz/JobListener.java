 ...
 * <code>{@link com.helger.quartz.JobDetail}</code> executes. In general, applications
 * that use a <code>Scheduler</code> will not have use for this mechanism.
 *
...
public interface JobListener
{
   ...
   * <code>{@link com.helger.quartz.JobDetail}</code> is about to be executed (an
   ...
   * <p>
   * Called by the <code>{@link Scheduler}</code> when a
   * <code>{@link com.helger.quartz.JobDetail}</code> was about to be executed (an
   ...
   * <code>{@link com.helger.quartz.JobDetail}</code> has been executed, and be for the
   * associated <code>Trigger</code>'s <code>triggered(xx)</code> method has
   * been called.
   * </p>
   */
