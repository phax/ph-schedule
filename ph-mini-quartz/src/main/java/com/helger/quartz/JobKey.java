 ...
 * <p>
 * Keys are composed of both a name and group, and the name must be unique within the group. If only
 * a group is specified then the default group name will be used.
 * </p>
 * <p>
