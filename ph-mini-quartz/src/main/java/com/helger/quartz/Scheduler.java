 ...
 * <code>{@link com.helger.quartz.JobDetail}</code>s and <code>{@link Trigger}</code>s.
 ...
 * class that implements the <code>{@link com.helger.quartz.Job}</code> interface.
 * <code>{@link JobDetail}</code> objects are then created (also by the client)
...
public interface Scheduler
{
   ...
   *
   * @see com.helger.quartz.JobDetail#requestsRecovery()
   */
  ...
  /**
   * Add the given <code>{@link com.helger.quartz.JobDetail}</code> to the Scheduler,
  ...
  /**
   * Remove all of the indicated <code>{@link Trigger}</code>s from the
   * scheduler.
   * <p>
   * If the related job does not have any other triggers, and the job is not
   * durable, then the job will also be deleted.
  ...
  /**
   * Trigger the identified <code>{@link com.helger.quartz.JobDetail}</code> (execute
   * it now).
   */
  ...
  /**
   * Pause the <code>{@link com.helger.quartz.JobDetail}</code> with the given key - by
  ...
  /**
   * Pause all of the <code>{@link com.helger.quartz.JobDetail}s</code> in the matching
  ...
  /**
   * Resume (un-pause) all of the <code>{@link Trigger}s</code> in matching
   * groups.
   * <p>
  ...
  /**
   * Get the names of all known <code>{@link com.helger.quartz.JobDetail}</code>
   * groups.
   */
  List <String> getJobGroupNames () throws SchedulerException;

  /**
   * Get the keys of all the <code>{@link com.helger.quartz.JobDetail}s</code> in the
   * matching groups.
   *
   * @param matcher
   ...
   *        {@link JobExecutionContext#getFireInstanceId()}
