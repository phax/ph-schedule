 ...
 * <code>JobListener</code>, <code>TriggerListener</code>, and/or
 * <code>SchedulerListener</code>.
 * </p>
 * <p>
 * If you use <code>{@link com.helger.quartz.impl.StdSchedulerFactory}</code> to
...
public interface ISchedulerPlugin
{
   ...
   * @param loadHelper
   *        The classLoadHelper the <code>SchedulerFactory</code> is actually
   *        using
  ...
  /**
   * <p>
   * Called when the associated <code>Scheduler</code> is started, in order to
