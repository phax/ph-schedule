 ...
 * or passively: by being a <code>JobListener</code>, <code>TriggerListener</code>, and/or
 * <code>SchedulerListener</code>.
 * </p>
 * <p>
 * If you use <code>{@link com.helger.quartz.impl.StdSchedulerFactory}</code> to initialize your
 ...
 * the <code>Scheduler</code>'s <code>SchedulerContext</code> as part of its
 * <code>{@link #initialize(String, IScheduler, IClassLoadHelper)}</code> method.
 * </p>
 *
 * @author James House
 */
public interface ISchedulerPlugin
{
   ...
   * </p>
   * <p>
   * If you need direct access your plugin, for example during <code>Job</code> execution, you can
   * have this method explicitly put a reference to this plugin in the <code>Scheduler</code>'s
