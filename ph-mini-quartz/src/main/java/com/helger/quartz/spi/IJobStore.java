...
public interface IJobStore extends Serializable
{
   ...
   * should free up all of it's resources because the scheduler is shutting down.
   */
  void shutdown ();
  ...
  /**
   * How long (in milliseconds) the <code>JobStore</code> implementation estimates
   * that it will take to release a trigger and acquire a new one.
   */
   ...
   * should be removed from the <code>JobStore</code>'s list of known group names.
   * </p>
   *
  ...
  /**
   * Remove (delete) the <code>{@link com.helger.quartz.ITrigger}</code> with the
   * given key, and store the new given one - which must be associated with the
   * same job.
   *
   * @param newTrigger
  ...
  /**
   * Remove (delete) the <code>{@link com.helger.quartz.ICalendar}</code> with the
   * given name.
   * <p>
   * If removal of the <code>Calendar</code> would result in <code>Trigger</code>s
   * pointing to non-existent calendars, then a
   ...
   * @return <code>true</code> if a <code>Calendar</code> with the given name was
   *         found and removed from the store.
   */
  ...
  /**
   * Get the number of <code>{@link com.helger.quartz.ITrigger}</code> s that are
   * stored in the <code>JobsStore</code>.
   */
  ...
  /**
   * Get the keys of all of the <code>{@link com.helger.quartz.IJob}</code> s that
  ...
  /**
   * Get the names of all of the <code>{@link com.helger.quartz.ITrigger}</code> s
  ...
  /**
   * Get the names of all of the <code>{@link com.helger.quartz.ICalendar}</code>
   * s in the <code>JobStore</code>.
   * <p>
  ...
  /**
   * Resume (un-pause) all of the <code>{@link com.helger.quartz.ITrigger}s</code>
   * in the given group.
   * <p>
  ...
  /**
   * Resume (un-pause) all of the <code>{@link com.helger.quartz.IJob}s</code> in
   * the given group.
   * <p>
  ...
  /**
   * Inform the <code>JobStore</code> that the scheduler has completed the firing
   * of the given <code>Trigger</code> (and the execution of its associated
   * <code>Job</code> completed, threw an exception, or was vetoed), and that the
