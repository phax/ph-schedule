 ...
 * <code>{@link com.helger.quartz.Job}</code> and
 * <code>{@link com.helger.quartz.Trigger}</code> storage mechanism for the
 ...
 * @see com.helger.quartz.JobDetail
...
public interface JobStore
{
  ...
  /**
   * Store the given <code>{@link com.helger.quartz.JobDetail}</code>.
   *
   * @param newJob
   *        The <code>JobDetail</code> to be stored.
  ...
  /**
   * Remove (delete) the <code>{@link com.helger.quartz.Job}</code> with the given key,
   * and any <code>{@link com.helger.quartz.Trigger}</code> s that reference it.
   * <p>
   ...
   */
  void storeTrigger (OperableTrigger newTrigger, boolean replaceExisting) throws ObjectAlreadyExistsException,
                                                                          JobPersistenceException;
  ...
  /**
   * Get the number of <code>{@link com.helger.quartz.Job}</code> s that are stored in
  ...
  /**
   * Get the keys of all of the <code>{@link com.helger.quartz.Job}</code> s that have
  ...
  /**
   * Pause the <code>{@link com.helger.quartz.Trigger}</code> with the given key.
   *
  ...
  /**
   * Pause all of the <code>{@link com.helger.quartz.Trigger}s</code> in the given
   * group.
   * <p>
  ...
  /**
   * Pause the <code>{@link com.helger.quartz.Job}</code> with the given name - by
  ...
  /**
   * Pause all of the <code>{@link com.helger.quartz.Job}s</code> in the given group -
  ...
  /**
   * Resume (un-pause) the <code>{@link com.helger.quartz.Trigger}</code> with the
   * given key.
   * <p>
  ...
  /**
   * Resume (un-pause) all of the <code>{@link com.helger.quartz.Trigger}s</code> in
   * the given group.
   * <p>
  ...
  /**
   * Resume (un-pause) the <code>{@link com.helger.quartz.Job}</code> with the given
   * key.
   * <p>
  ...
  /**
   * Resume (un-pause) all of the <code>{@link com.helger.quartz.Job}s</code> in the
   * given group.
   * <p>
