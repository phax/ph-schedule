 ...
 * for the <code>{@link com.helger.quartz.core.QuartzScheduler}</code>'s use.
 * </p>
 * <p>
 * <code>ThreadPool</code> implementation instances should ideally be made for
 ...
 * <code>runInThread(Runnable)</code> is called a few moments (or many moments)
...
public interface IThreadPool
{
   ...
   * no immediately available threads <code>false</code> should be returned.
   * </p>
   *
   ...
   * </p>
   * <p>
   * The implementation of this method should block until there is at least one
   * available thread.
   * </p>
   *
  ...
  /**
   * <p>
   * Must be called before the <code>ThreadPool</code> is used, in order to give
  ...
  /**
   * <p>
   * Called by the QuartzScheduler to inform the <code>ThreadPool</code> that it
  ...
  /**
   * <p>
   * Inform the <code>ThreadPool</code> of the Scheduler instance's Id, prior to
  ...
  /**
   * <p>
   * Inform the <code>ThreadPool</code> of the Scheduler instance's name, prior
