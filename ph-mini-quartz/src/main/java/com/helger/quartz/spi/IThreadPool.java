 ...
 * </p>
 * <p>
 * <code>ThreadPool</code> implementation instances should ideally be made for the sole use of
...
public interface IThreadPool
{
  /**
   * <p>
   * Execute the given <code>{@link java.lang.Runnable}</code> in the next available
   * <code>Thread</code>.
   * </p>
   * <p>
   * The implementation of this interface should not throw exceptions unless there is a serious
   * problem (i.e. a serious misconfiguration). If there are no immediately available threads
