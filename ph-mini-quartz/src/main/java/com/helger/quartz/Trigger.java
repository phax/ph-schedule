...
public interface Trigger extends Serializable, Cloneable, Comparable <Trigger>
{
   ...
   * <code>{@link com.helger.quartz.JobDetail}</code> to re-execute immediately. If not
   ...
   * <code>{@link Scheduler}</code> that the <code>{@link Trigger}</code> should
   ...
   * the same <code>{@link com.helger.quartz.JobDetail}</code> as this one should be
   * put in the <code>COMPLETE</code> state.
   * </p>
   * <p>
   * <code>SET_TRIGGER_ERROR</code> Instructs the <code>{@link Scheduler}</code>
   * that all <code>Trigger</code>s referencing the same
   * <code>{@link com.helger.quartz.JobDetail}</code> as this one should be put in the
   * <code>ERROR</code> state.
   * </p>
   * <p>
   * <code>SET_ALL_JOB_TRIGGERS_ERROR</code> Instructs the
   * <code>{@link Scheduler}</code> that the <code>Trigger</code> should be put
   ...
   *      Calendar, java.util.Date, java.util.Date)
   */
