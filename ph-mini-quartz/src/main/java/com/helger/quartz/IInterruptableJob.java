...
/**
 * The interface to be implemented by <code>{@link IJob}s</code> that provide a
 ...
 * jobs will.
 * <p>
 * Interrupting a <code>Job</code> is very analogous in concept and challenge to
 * normal interruption of a <code>Thread</code> in Java.
 * <p>
 ...
 * of the job's <code>execute(..)</code> periodically check some flag to see if
 ...
 * <code>interrupt()</code> on that Thread. Before attempting this, make sure
 * that you fully understand what <code>java.lang.Thread.interrupt()</code> does
 ...
 * </p>
 * <p>
 * See Example 7 (org.quartz.examples.example7.DumbInterruptableJob) for a
 * simple implementation demonstration.
 * </p>
 *
 * @see IJob
...
public interface IInterruptableJob extends IJob
{
  /**
   * <p>
   * Called by the <code>{@link IScheduler}</code> when a user interrupts the
   * <code>Job</code>.
   * </p>
   *
