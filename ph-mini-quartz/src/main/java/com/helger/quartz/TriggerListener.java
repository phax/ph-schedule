...
public interface TriggerListener
{
   ...
   * <code>{@link Trigger}</code> has fired, and it's associated
   * <code>{@link com.helger.quartz.JobDetail}</code> is about to be executed.
   * </p>
   * <p>
   ...
   * Called by the <code>{@link Scheduler}</code> when a
   * <code>{@link Trigger}</code> has fired, and it's associated
   * <code>{@link com.helger.quartz.JobDetail}</code> is about to be executed. If the
   * implementation vetos the execution (via returning <code>true</code>), the
   * job's execute method will not be called.
   * </p>
   * <p>
   ...
   * <p>
   * Called by the <code>{@link Scheduler}</code> when a
   * <code>{@link Trigger}</code> has misfired.
   * </p>
   * <p>
   ...
   * <p>
   * Called by the <code>{@link Scheduler}</code> when a
   * <code>{@link Trigger}</code> has fired, it's associated
   * <code>{@link com.helger.quartz.JobDetail}</code> has been executed, and it's
