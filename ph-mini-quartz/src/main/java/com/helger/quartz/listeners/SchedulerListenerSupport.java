 ...
 * <code>{@link com.helger.quartz.SchedulerListener}</code>.
 * <p>
 * The methods in this class are empty so you only need to override the subset
 * for the <code>{@link com.helger.quartz.SchedulerListener}</code> events you care
 * about.
 * </p>
 *
 * @see com.helger.quartz.SchedulerListener
 */
