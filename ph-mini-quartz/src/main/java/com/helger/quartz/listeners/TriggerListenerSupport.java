 ...
 * <code>{@link com.helger.quartz.TriggerListener}</code>.
 * <p>
 * The methods in this class are empty so you only need to override the subset
 * for the <code>{@link com.helger.quartz.TriggerListener}</code> events you care
 * about.
 * </p>
 * <p>
 * You are required to implement
 * <code>{@link com.helger.quartz.TriggerListener#getName()}</code> to return the
 * unique name of your <code>TriggerListener</code>.
 * </p>
 *
 * @see com.helger.quartz.TriggerListener
 */
