...
public interface Trigger extends Serializable, Cloneable, Comparable <Trigger>
{
   ...
   * <code>{@link org.quartz.JobDetail}</code> to re-execute immediately. If not
   ...
   * <code>{@link org.quartz.JobDetail}</code> as this one should be put in the
   ...
   * <code>{@link org.quartz.spi.JobStore}</code>.
   * </p>
   */
