 ...
 * <code>{@link org.quartz.JobDetail}</code>s and <code>{@link Trigger}</code>s.
...
public interface Scheduler
{
  ...
  /**
   * Pause the <code>{@link org.quartz.JobDetail}</code> with the given key - by
  ...
  /**
   * Get the keys of all the <code>{@link org.quartz.JobDetail}s</code> in the
   * matching groups.
   *
   * @param matcher
