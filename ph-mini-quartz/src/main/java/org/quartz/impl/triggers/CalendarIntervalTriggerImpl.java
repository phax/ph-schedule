 ...
 * <code>{@link org.quartz.JobDetail}</code> based upon repeating calendar time
 * intervals.
 * </p>
 * <p>
 * The trigger will fire every N (see {@link #setRepeatInterval(int)} ) units of
 * calendar time (see
 * {@link #setRepeatIntervalUnit(org.quartz.DateBuilder.IntervalUnit)}) as
                                         ...
                                         implements CalendarIntervalTrigger, CoreTrigger
{
  ...
  private boolean preserveHourOfDayAcrossDaylightSavings = false; // false is
                                                                  // backward-compatible
                                                                  // with
                                                                  // behavior
  ...
  /**
   * @see org.quartz.spi.OperableTrigger#updateWithNewCalendar(org.quartz.Calendar,
   *      long)
   */
  @Override
